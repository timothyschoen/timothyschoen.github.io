...
function create_topbar() {
  ...
  let labels = [["HOME", "./index.html"], ["ABOUT", "./about.html"], ["CONTACT", "./contact.html"]];
      ...
      for (let i = 0; i < labels.length; i++) {
        ...
        buttons[i].style.cssText = "border-radius:0%; border:none; outline:none; font-size:12px; color:white; background-color:transparent; position:relative;  top:10px; left:15%;"
