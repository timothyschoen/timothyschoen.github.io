/* Declares the GreenLight Audio Worklet Node */

class GreenLightController extends WAMController
{
  ...
  static importScripts (actx) {
    ...
    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/GreenLight-wam.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/GreenLight-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
