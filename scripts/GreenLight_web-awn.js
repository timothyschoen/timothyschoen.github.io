/* Declares the GreenLight_web Audio Worklet Node */

class GreenLight_webController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "GreenLight_web", options);
  }
  ...
  static importScripts (actx) {
    ...
    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/GreenLight_web-wam.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/GreenLight_web-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
