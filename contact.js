...
function contact() {
	...
	contact_info.style.cssText = "font-family: LucidaGrande; border-radius:0%; border:none; outline:none; font-size:14px; color:white; background-color:transparent; position:absolute; top:130px; height:70px; left:40px; width:40%;";
